# AwlsomeLinux (Installer Branch)
 
The creation of this branch will focus on perfecting AwlsomeLinux by implicating an Installer which can be used to clean and format a drive to install AwlsomeLinux on. Basically, an Installer Program will be added to the Overlay Directory, the Overlay Directory will be compressed, and that along with the Core and a compressed Image Directory will be copied to the selected drive, and would be freshly installed.
