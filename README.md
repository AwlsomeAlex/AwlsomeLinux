...
## News 2/9/17: Progress will continue:
Even with a still-broken computer, along with AwlsomeLinux now being broken from Linux Kernel 4.9.8, Busybox 1.26.2, and GlibC 2.25, I see that I can't let this project die, and because of that, I'm continuing development of the project going **very** slowly due to me having a life, where I setup my server as a compiling tool, various chroot/containers for x86 development, and my laptop for coding. I wish to have my main computer back up by next month, so this will be a rough month.
